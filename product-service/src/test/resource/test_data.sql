...
insert into t_product(created,modified,ean,name,price_id,expiration_date,producer_id) values(now(),now(),'1234','jersey',1,'2023-11-10',1);
insert into t_product(created,modified,ean,name,price_id,expiration_date,producer_id) values(now(),now(),'5678','shorts',2,'2030-11-04',1);
...
insert into t_rating (created,modified,average_assessment,counts) values(now(),now(),5,1);
insert into t_rating (created,modified,average_assessment,counts) values(now(),now(),10,1);
